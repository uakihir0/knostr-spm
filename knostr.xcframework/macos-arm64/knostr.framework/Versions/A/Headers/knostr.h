...
- (id<KnostrSocialSocialCache>)cache __attribute__((swift_name("cache()")));
- (id<KnostrSocialChannelResource>)channels __attribute__((swift_name("channels()")));
- (KnostrSocialNostrSocialConfig *)config __attribute__((swift_name("config()")));
- (id<KnostrSocialEnrichmentResource>)enrichment __attribute__((swift_name("enrichment()")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)queryEventsWithTimeoutFilters:(NSArray<KnostrCoreNostrFilter *> *)filters timeoutMs:(int64_t)timeoutMs completionHandler:(void (^)(KnostrCoreResponse<NSArray<KnostrCoreNostrEvent *> *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("queryEventsWithTimeout(filters:timeoutMs:completionHandler:)")));
- (KnostrCoreResponse<NSArray<KnostrCoreNostrEvent *> *> *)queryEventsWithTimeoutBlockingFilters:(NSArray<KnostrCoreNostrFilter *> *)filters timeoutMs:(int64_t)timeoutMs __attribute__((swift_name("queryEventsWithTimeoutBlocking(filters:timeoutMs:)")));
@end
 ...
 */
- (void)addRelayStateListenerListener:(void (^)(NSString *, KnostrBoolean *))listener __attribute__((swift_name("addRelayStateListener(listener:)")));
...
- (void)removeRelayStateListenerListener:(void (^)(NSString *, KnostrBoolean *))listener __attribute__((swift_name("removeRelayStateListener(listener:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)subscribeFilters:(NSArray<KnostrCoreNostrFilter *> *)filters onEvent:(void (^)(KnostrCoreNostrEvent *))onEvent onEose:(void (^ _Nullable)(NSString *))onEose onClosed:(void (^ _Nullable)(NSString *, NSString *))onClosed onRequestSending:(void (^ _Nullable)(NSString *))onRequestSending onRequestFailed:(void (^ _Nullable)(NSString *, KnostrKotlinException *))onRequestFailed completionHandler:(void (^)(NSString * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("subscribe(filters:onEvent:onEose:onClosed:onRequestSending:onRequestFailed:completionHandler:)")));
 ...
 */
__attribute__((swift_name("SocialSocialCache")))
@protocol KnostrSocialSocialCache
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getRequest:(KnostrSocialSocialDataRequest *)request completionHandler:(void (^)(KnostrSocialSocialDataBatch * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("get(request:completionHandler:)")));
- (KnostrSocialSocialDataBatch *)getBlockingRequest:(KnostrSocialSocialDataRequest *)request __attribute__((swift_name("getBlocking(request:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)putBatch:(KnostrSocialSocialDataBatch *)batch completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("put(batch:completionHandler:)")));
- (void)putBlockingBatch:(KnostrSocialSocialDataBatch *)batch __attribute__((swift_name("putBlocking(batch:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)removeRequest:(KnostrSocialSocialDataRequest *)request completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("remove(request:completionHandler:)")));
- (void)removeBlockingRequest:(KnostrSocialSocialDataRequest *)request __attribute__((swift_name("removeBlocking(request:)")));
@end
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (class, readonly, getter=companion) KnostrSocialNostrSocialConfigCompanion *companion __attribute__((swift_name("companion")));
...
@property double deferredEnrichmentBackoffMultiplier __attribute__((swift_name("deferredEnrichmentBackoffMultiplier")));

/** Whether missing social data should be resolved in the background. */
@property BOOL deferredEnrichmentEnabled __attribute__((swift_name("deferredEnrichmentEnabled")));

/** Delay before the first background attempt. */
@property int64_t deferredEnrichmentInitialDelayMs __attribute__((swift_name("deferredEnrichmentInitialDelayMs")));

/** Number of background relay attempts after the synchronous request. */
@property int32_t deferredEnrichmentMaxAttempts __attribute__((swift_name("deferredEnrichmentMaxAttempts")));
 ...
 */
@property NSString *mediaUploadServerUrl __attribute__((swift_name("mediaUploadServerUrl")));

/** ノートキャッシュの有効期限 (ミリ秒) */
@property int64_t noteCacheTtlMs __attribute__((swift_name("noteCacheTtlMs")));

/** ノート統計キャッシュの有効期限 (ミリ秒) */
@property int64_t noteStatsCacheTtlMs __attribute__((swift_name("noteStatsCacheTtlMs")));
 ...
 */
@property int64_t referencedEventLookupTimeoutMs __attribute__((swift_name("referencedEventLookupTimeoutMs")));

/** Optional application-provided social cache. */
@property id<KnostrSocialSocialCache> _Nullable socialCache __attribute__((swift_name("socialCache")));

/** ユーザープロフィールキャッシュの有効期限 (ミリ秒) */
@property int64_t userProfileCacheTtlMs __attribute__((swift_name("userProfileCacheTtlMs")));
@end

__attribute__((swift_name("SocialEnrichmentResource")))
@protocol KnostrSocialEnrichmentResource
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)cancelPendingWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("cancelPending(completionHandler:)")));

/** Cancel queued work while keeping this resource reusable. */
- (void)cancelPendingBlocking __attribute__((swift_name("cancelPendingBlocking()")));

/** Permanently stop background enrichment and release its callback. */
- (void)close __attribute__((swift_name("close()")));

/** Queue data for asynchronous resolution. */
- (void)requestRequest:(KnostrSocialSocialDataRequest *)request forceRefresh:(BOOL)forceRefresh __attribute__((swift_name("request(request:forceRefresh:)")));

/** Called on a background coroutine with each successfully resolved batch. */
@property void (^ _Nullable onUpdateCallback)(KnostrSocialSocialDataBatch *) __attribute__((swift_name("onUpdateCallback")));
@end
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)replyContent:(NSString *)content tags:(NSArray<NSArray<NSString *> *> *)tags replyToEventId:(NSString *)replyToEventId rootEventId:(NSString * _Nullable)rootEventId contentWarning:(NSString * _Nullable)contentWarning expiry:(KnostrLong * _Nullable)expiry sensitive:(BOOL)sensitive completionHandler:(void (^)(KnostrCoreResponse<KnostrCoreNostrEvent *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("reply(content:tags:replyToEventId:rootEventId:contentWarning:expiry:sensitive:completionHandler:)")));
- (KnostrCoreResponse<KnostrCoreNostrEvent *> *)replyBlockingContent:(NSString *)content replyToEventId:(NSString *)replyToEventId rootEventId:(NSString * _Nullable)rootEventId contentWarning:(NSString * _Nullable)contentWarning expiry:(KnostrLong * _Nullable)expiry sensitive:(BOOL)sensitive __attribute__((swift_name("replyBlocking(content:replyToEventId:rootEventId:contentWarning:expiry:sensitive:)"))) __attribute__((deprecated("Use the overload that accepts tags")));
- (KnostrCoreResponse<KnostrCoreNostrEvent *> *)replyBlockingContent:(NSString *)content tags:(NSArray<NSArray<NSString *> *> *)tags replyToEventId:(NSString *)replyToEventId rootEventId:(NSString * _Nullable)rootEventId contentWarning:(NSString * _Nullable)contentWarning expiry:(KnostrLong * _Nullable)expiry sensitive:(BOOL)sensitive __attribute__((swift_name("replyBlocking(content:tags:replyToEventId:rootEventId:contentWarning:expiry:sensitive:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)uploadAndPostFileData:(KnostrKotlinByteArray *)fileData fileName:(NSString *)fileName mimeType:(NSString *)mimeType content:(NSString *)content description:(NSString *)description tags:(NSArray<NSArray<NSString *> *> *)tags contentWarning:(NSString * _Nullable)contentWarning expiry:(KnostrLong * _Nullable)expiry sensitive:(BOOL)sensitive completionHandler:(void (^)(KnostrCoreResponse<KnostrSocialNostrMediaPost *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("uploadAndPost(fileData:fileName:mimeType:content:description:tags:contentWarning:expiry:sensitive:completionHandler:)")));
- (KnostrCoreResponse<KnostrSocialNostrMediaPost *> *)uploadAndPostBlockingFileData:(KnostrKotlinByteArray *)fileData fileName:(NSString *)fileName mimeType:(NSString *)mimeType content:(NSString *)content description:(NSString *)description tags:(NSArray<NSArray<NSString *> *> *)tags contentWarning:(NSString * _Nullable)contentWarning expiry:(KnostrLong * _Nullable)expiry sensitive:(BOOL)sensitive __attribute__((swift_name("uploadAndPostBlocking(fileData:fileName:mimeType:content:description:tags:contentWarning:expiry:sensitive:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)uploadAndReplyUploads:(NSArray<KnostrSocialNostrMediaUpload *> *)uploads replyToEventId:(NSString *)replyToEventId content:(NSString *)content rootEventId:(NSString * _Nullable)rootEventId tags:(NSArray<NSArray<NSString *> *> *)tags contentWarning:(NSString * _Nullable)contentWarning expiry:(KnostrLong * _Nullable)expiry sensitive:(BOOL)sensitive completionHandler:(void (^)(KnostrCoreResponse<KnostrSocialNostrMediaPost *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("uploadAndReply(uploads:replyToEventId:content:rootEventId:tags:contentWarning:expiry:sensitive:completionHandler:)")));
- (KnostrCoreResponse<KnostrSocialNostrMediaPost *> *)uploadAndReplyBlockingUploads:(NSArray<KnostrSocialNostrMediaUpload *> *)uploads replyToEventId:(NSString *)replyToEventId content:(NSString *)content rootEventId:(NSString * _Nullable)rootEventId tags:(NSArray<NSArray<NSString *> *> *)tags contentWarning:(NSString * _Nullable)contentWarning expiry:(KnostrLong * _Nullable)expiry sensitive:(BOOL)sensitive __attribute__((swift_name("uploadAndReplyBlocking(uploads:replyToEventId:content:rootEventId:tags:contentWarning:expiry:sensitive:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)uploadManyAndPostUploads:(NSArray<KnostrSocialNostrMediaUpload *> *)uploads content:(NSString *)content tags:(NSArray<NSArray<NSString *> *> *)tags contentWarning:(NSString * _Nullable)contentWarning expiry:(KnostrLong * _Nullable)expiry sensitive:(BOOL)sensitive completionHandler:(void (^)(KnostrCoreResponse<KnostrSocialNostrMediaPost *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("uploadManyAndPost(uploads:content:tags:contentWarning:expiry:sensitive:completionHandler:)")));
- (KnostrCoreResponse<KnostrSocialNostrMediaPost *> *)uploadManyAndPostBlockingUploads:(NSArray<KnostrSocialNostrMediaUpload *> *)uploads content:(NSString *)content tags:(NSArray<NSArray<NSString *> *> *)tags contentWarning:(NSString * _Nullable)contentWarning expiry:(KnostrLong * _Nullable)expiry sensitive:(BOOL)sensitive __attribute__((swift_name("uploadManyAndPostBlocking(uploads:content:tags:contentWarning:expiry:sensitive:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)uploadToConfiguredServerFileData:(KnostrKotlinByteArray *)fileData fileName:(NSString *)fileName mimeType:(NSString *)mimeType description:(NSString *)description completionHandler:(void (^)(KnostrCoreResponse<KnostrSocialNostrMedia *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("uploadToConfiguredServer(fileData:fileName:mimeType:description:completionHandler:)")));
- (KnostrCoreResponse<KnostrSocialNostrMedia *> *)uploadToConfiguredServerBlockingFileData:(KnostrKotlinByteArray *)fileData fileName:(NSString *)fileName mimeType:(NSString *)mimeType description:(NSString *)description __attribute__((swift_name("uploadToConfiguredServerBlocking(fileData:fileName:mimeType:description:)")));
@end
...
@property BOOL isComplete __attribute__((swift_name("isComplete")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SocialSocialDataRequest")))
@interface KnostrSocialSocialDataRequest : KnostrBase
- (instancetype)initWithUserPubkeys:(NSArray<NSString *> *)userPubkeys noteIds:(NSArray<NSString *> *)noteIds noteStatsEventIds:(NSArray<NSString *> *)noteStatsEventIds __attribute__((swift_name("init(userPubkeys:noteIds:noteStatsEventIds:)"))) __attribute__((objc_designated_initializer));
- (BOOL)isEmpty __attribute__((swift_name("isEmpty()")));
@property NSArray<NSString *> *noteIds __attribute__((swift_name("noteIds")));
@property NSArray<NSString *> *noteStatsEventIds __attribute__((swift_name("noteStatsEventIds")));
@property NSArray<NSString *> *userPubkeys __attribute__((swift_name("userPubkeys")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SocialSocialDataBatch")))
@interface KnostrSocialSocialDataBatch : KnostrBase
- (instancetype)initWithUsers:(NSArray<KnostrSocialNostrUser *> *)users notes:(NSArray<KnostrSocialNostrNote *> *)notes noteStats:(NSArray<KnostrSocialNostrNoteStats *> *)noteStats __attribute__((swift_name("init(users:notes:noteStats:)"))) __attribute__((objc_designated_initializer));
- (BOOL)isEmpty __attribute__((swift_name("isEmpty()")));
@property NSArray<KnostrSocialNostrNoteStats *> *noteStats __attribute__((swift_name("noteStats")));
@property NSArray<KnostrSocialNostrNote *> *notes __attribute__((swift_name("notes")));
@property NSArray<KnostrSocialNostrUser *> *users __attribute__((swift_name("users")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SocialNostrSocialConfig.Companion")))
@interface KnostrSocialNostrSocialConfigCompanion : KnostrBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) KnostrSocialNostrSocialConfigCompanion *shared __attribute__((swift_name("shared")));

/** Widely used public NIP-96 media server. */
@property (readonly) NSString *DEFAULT_MEDIA_UPLOAD_SERVER_URL __attribute__((swift_name("DEFAULT_MEDIA_UPLOAD_SERVER_URL")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SocialNostrMediaPost")))
@interface KnostrSocialNostrMediaPost : KnostrBase
- (instancetype)initWithMedia:(KnostrSocialNostrMedia *)media event:(KnostrCoreNostrEvent *)event __attribute__((swift_name("init(media:event:)"))) __attribute__((objc_designated_initializer));
@property KnostrCoreNostrEvent *event __attribute__((swift_name("event")));

/** First uploaded media. */
@property (readonly) KnostrSocialNostrMedia *media __attribute__((swift_name("media")));

/** All uploaded media. For the single-image API this contains [media] only. */
@property (readonly) NSArray<KnostrSocialNostrMedia *> *medias __attribute__((swift_name("medias")));
@end


/** File input for configured NIP-96 upload operations. */
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SocialNostrMediaUpload")))
@interface KnostrSocialNostrMediaUpload : KnostrBase
- (instancetype)initWithFileData:(KnostrKotlinByteArray *)fileData fileName:(NSString *)fileName mimeType:(NSString *)mimeType description:(NSString *)description __attribute__((swift_name("init(fileData:fileName:mimeType:description:)"))) __attribute__((objc_designated_initializer));
@property (readonly) NSString *description_ __attribute__((swift_name("description_")));
@property (readonly) KnostrKotlinByteArray *fileData __attribute__((swift_name("fileData")));
...
@property NSString *senderPubkey __attribute__((swift_name("senderPubkey")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SocialNostrNoteStats")))
@interface KnostrSocialNostrNoteStats : KnostrBase
- (instancetype)initWithEventId:(NSString *)eventId likeCount:(int32_t)likeCount replyCount:(int32_t)replyCount repostCount:(int32_t)repostCount __attribute__((swift_name("init(eventId:likeCount:replyCount:repostCount:)"))) __attribute__((objc_designated_initializer));
